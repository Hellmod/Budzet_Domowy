			...
			<div class="row">
				...
				<div class="col-sm-6 offset-sm-3">
					<sf:form id="usersForm" action="updateprofil" modelAttribute="user" enctype="multipart/form-data" method="POST">
						...
						<td ><button type="submit" class="btn btn-primary" /><i class="fas fa-check-circle"></i> <s:message code="button.save"/></td>
						<td ><button type="reset" class="btn btn-primary" onclick="window.location.href='${pageContext.request.contextPath}/'"/><i class="fas fa-times-circle"></i> <s:message code="button.cancel"/></td>
