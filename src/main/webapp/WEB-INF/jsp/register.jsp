			...
			<div class="row">
				...
				<div class="col-sm-6 offset-sm-3">
					<sf:form id="usersForm" action="adduser" modelAttribute="user" enctype="multipart/form-data" method="POST">
						...
						<button id="submit" type="submit" class="btn btn-primary" disabled><i class="fas fa-check-circle"></i> <s:message code="button.register" /></button>
						<button type="reset" class="btn btn-primary" onclick="window.location.href='${pageContext.request.contextPath}/'"><i class="fas fa-times-circle"></i> <s:message code="button.cancel" /></button>
